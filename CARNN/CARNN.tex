...
\begin{table}[!htbp]
\centering
\caption{Performance of CA-RNN with different method of computing the $\textbf{M}_{c_{I,k}^{u}}$ evaluated by reall, MAP}\label{tab:aStrangeTable}
\begin{tabular}{ccccc}
\toprule
Method& recall@1& recall@5& recall@10& MAP\\
\midrule
Linear& 0& 0& 0& 0\\
Nonlinear& 0& 0& 0& 0\\
Mutiplied& 0& 0& 0& 0\\
